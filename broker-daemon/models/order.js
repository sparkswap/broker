...
class Order {
   ...
   */
  constructor (blockOrderId, { baseSymbol, counterSymbol, side, baseAmount, counterAmount, makerAddress }) {
   ...
   */
  get paramsForCreate () {
    const { baseSymbol, counterSymbol, side, baseAmount, counterAmount, makerAddress } = this

    return { baseSymbol, counterSymbol, side, baseAmount, counterAmount, makerAddress }
  }
  ...
  static fromObject (key, valueObject) {
    ...
    const { baseSymbol, counterSymbol, side, baseAmount, counterAmount, makerAddress, ...otherParams } = valueObject

    // instantiate with the correct set of params
    const order = new this(blockOrderId, { baseSymbol, counterSymbol, side, baseAmount, counterAmount, makerAddress })
