...
class WalletService {
   ...
   */
  constructor (protoPath, { logger, engines, relayer, orderbooks }) {
    ...
    this.implementation = {
      ...
      commit: new GrpcUnaryMethod(commit, this.messageId('commit'), { logger, engines, relayer, orderbooks }, { EmptyResponse }).register(),
