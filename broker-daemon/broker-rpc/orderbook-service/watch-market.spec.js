...
describe('watchMarket', () => {
  ...
  it('sends add events', async () => {
    ...
    expect(EventType).to.have.been.calledOnce()
    expect(EventType).to.have.been.calledWith({ type: 'ADD', marketEvent: fakeSerialized })
  })
  ...
  it('sends delete events if type is del', async () => {
    ...
    expect(sendStub).to.have.been.calledOnce()
    expect(EventType).to.have.been.calledOnce()
    expect(EventType).to.have.been.calledWith({ type: 'DELETE', marketEvent: marketEvent })
  })
})
