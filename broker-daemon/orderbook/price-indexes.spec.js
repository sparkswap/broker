...
const Indexes = rewire(path.resolve(__dirname, 'price-indexes'))

describe.only('price-indexes', () => {
  let store
  ...
  beforeEach(() => {
    ...
    Indexes.__set__('MarketEventOrder', {
  ...
  describe('PriceIndex', () => {
    ...
    beforeEach(() => {
      PriceIndex = Indexes.__get__('PriceIndex')
      side = 'ASK'
      price = '100'
      MarketEventOrderFromStorage.returns({
        orderId: 'abc',
        side,
        price
      })
