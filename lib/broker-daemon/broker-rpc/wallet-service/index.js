...
class WalletService {
    constructor(protoPath, { engines, relayer, orderbooks, blockOrderWorker, auth, logger }) {
        ...
        const { NewDepositAddressResponse, GetBalancesResponse, GetPaymentChannelNetworkAddressResponse, GetTradingCapacitiesResponse, WithdrawFundsResponse, CreateWalletResponse, ReleaseChannelsResponse, google: { protobuf: { Empty: EmptyResponse } } } = this.proto.broker.rpc;
        this.implementation = {
