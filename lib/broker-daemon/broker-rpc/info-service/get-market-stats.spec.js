...
describe('getMarketStats', () => {
    ...
    describe('error handling', () => {
        it('throws an error if orderbook is not found', () => {
            orderbooks = new Map();
            return expect(getMarketStats({ orderbooks, logger, params }, { GetMarketStatsResponse })).to.eventually.be.rejectedWith(market, 'not being tracked as a market');
        });
    });
    describe('getMarketStats', () => {
        let orderbookEvents;
...
//# sourceMappingURL=get-market-stats.spec.js.map