...
class MarketEvent {
    constructor(_a) {
        var { eventId, orderId, timestamp, eventType, sequence } = _a, payload = __rest(_a, ["eventId", "orderId", "timestamp", "eventType", "sequence"]);
    ...
    get value() {
        ...
        return JSON.stringify(Object.assign({ orderId, eventType }, payload));
    }
    amount(baseSymbol) {
    ...
    static fromStorage(key, value) {
        ...
        return new this(Object.assign({ timestamp, sequence, eventId }, JSON.parse(value)));
    }
...
//# sourceMappingURL=market-event.js.map