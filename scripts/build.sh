...
rm -rf ./proto/relayer
git clone -b feature/pass-base-and-counter-addresses git@github.com:kinesis-exchange/relayer.git ./proto/relayer
cp ./proto/relayer/proto/dist/relayer.proto ./proto/
rm -rf ./proto/relayer
